  ...
  <v-container class="ecom-auth-page" fluid>
    ...
    <header class="ecom-header">
      ...
      <div class="ecom-actions">
        <v-btn variant="outlined" @click="$router.push('/ecommerce/login')">
          Sign In
        </v-btn>
      </div>
    </header>
    ...
    <main class="auth-content">
      <div class="auth-card">
        <div class="auth-eyebrow">Join Evercart</div>
        <h1 class="auth-title">Create your account</h1>
        <p class="auth-lede">
          Get started with exclusive deals and faster checkout.
        </p>
        ...
        <div class="auth-footer">
          ...
          <RouterLink to="/ecommerce/login" class="auth-link">Sign in</RouterLink>
        </div>
      </div>
    </main>
